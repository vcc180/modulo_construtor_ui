<form method="POST">
    <div class="box">
        <h1 class="title-box">Editar Menu</h1>
        <?php
        ...
        if (!isset($_POST['data'])) {
            ...
            $modelo->form_data = $modelo->db->select('tbmenu', '*', 'where menu_id=' . $_REQUEST['menu_id']);
        ...
        <div class="formulario">
            ...
            <div class="field"> <legend>Título:</legend>
                <input id="menu_title" class="txt_input" type="text" name="data[menu_title]" value="<?php echo isset($modelo->form_data['menu_title']) ? $modelo->form_data['menu_title'] : '' ?>"/>
            </div>
            

            <div class="field"> <legend>Nome:</legend>
                <input id="menu_nome" class="txt_input" type="text" name="data[menu_nome]" value="<?php echo isset($modelo->form_data['menu_nome']) ? $modelo->form_data['menu_nome'] : '' ?>"/>
            </div>
            ...
            <div class="field"> <legend>Status:</legend>
                <input class="txt_input" type="checkbox" name="data[menu_status]" value="true"  <?php echo  isset($modelo->form_data['menu_status']) && $modelo->form_data['menu_status'] ==true ? 'checked' : '' ?>/>
            </div>
