...
<div class='box'>
    ...
    <div class='filtros'>
        ...
        <div class="field">
            <legend>&nbsp;</legend><button onclick="Location('projetos/cadastro')" class="button button-blue"><i class="fa fa-plus-circle"></i> CADASTRAR</button>
        </div>
    </div>
</div>
<div class="box">
    ...
    $LINK_BUILD = HOME_URI . 'api/build.php?';
    ...
    $tab->setAction("<i class='fa fa-code'></i>", $LINK_BUILD, array('projeto_id', 'projeto_title'));
